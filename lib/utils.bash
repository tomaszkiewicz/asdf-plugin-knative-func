...
# NOTE: You might want to remove this if knative-func is not hosted on GitHub releases.
...
list_all_versions() {
	...
	# Change this function if knative-func has other means of determining installable versions.
	list_github_tags
}
